...
public class SuvarnaAccount {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.name("firstName")).sendKeys("Suvarna");
        Thread.sleep(2000);
        driver.findElement(By.name("lastName")).sendKeys("M S");
        Thread.sleep(2000);
        driver.findElement(By.name("Username")).sendKeys("suvarnawifeofprakash");
        Thread.sleep(2000);
        driver.findElement(By.name("Passwd")).sendKeys("suvarna@prakash123");
        Thread.sleep(2000);
        driver.findElement(By.name("ConfirmPasswd")).sendKeys("suvarna@prakash123");
        Thread.sleep(2000);
...
//        alert.dismiss();
        ...
        driver.findElement(By.xpath("(//span[@class='Rq5Gcb'])[7]")).click();
